...
export default function ArticleSeedCard({
    ...
    return (
        <div
            className={"relative mb-2 p-0.5 bg-gradient-to-br from-purple-500 to-pink-500"}
        >
            <article
                key={articleSeedData.externalId}
                    ...
                    <div className="p-6 flex-grow flex flex-col justify-between w-2/3">
                        <div>
                            <h2 className="text-xl font-semibold text-gray-900 hover:text-gray-700 mb-2">
                                {articleSeedData.title}
                            </h2>
                            {articleSeedData.summary && (
                        ...
                        <div className="flex items-center text-sm text-gray-500">
                            <span>
                                {articleSeedData?.author || "Unknown author"}
                            </span>
                            <span className="mx-2">·</span>
                            <span>
                                {articleSeedData?.category || "Unknown Category"}
                            </span>
                            <span className="mx-2">·</span>
                            <span>
                                {/* {articleSeedData?.publishDate?.toLocaleDateString('fr-FR', { day: '2-digit', month: '2-digit', year: 'numeric' })} */}
                            </span>
                        </div>
