...
export default function ArticleEditDrawer({ article, isOpen, onClose, unsaveArticle }: ArticleSeedDrawerProps) {
                ...
                <div className="p-6">
                    ...
                    <form action={handleSubmit}>
                        ...
                        <div className="sticky bottom-0 left-0 right-0 bg-gray-50 p-4 border-t shadow-md flex justify-end space-x-2 z-10">
                            ...
                            <Button className="flex items-center bg-red-500 hover:bg-red-600 text-white hover:text-white" type="button" onClick={() => { unsaveArticle(); close(); }}>Unsave Article <TrashIcon className="h-4 w-4 ml-1 inline-block" /></Button>
